...
import { tool } from "@beastcli/plugin"
...
This tool searches PRs in the simpletoolsindia/code-cli repository and returns LLM-friendly results including:
- PR number and title
- Author
