...
Use this folder for locale-specific translation guidance that supplements `.beastcli/agent/translator.md`.
...
- PR #12345: https://github.com/simpletoolsindia/code-cli/pull/12345

## Do Not Translate (Locale Additions)

- `BeastCLI` (preserve casing)
