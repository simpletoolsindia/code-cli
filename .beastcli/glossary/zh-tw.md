...
- PR #13942: https://github.com/simpletoolsindia/code-cli/pull/13942

## Do Not Translate (Locale Additions)

- `BeastCLI` (preserve casing in prose; keep `beast` only when it is part of commands, package names, paths, or code)
- `BeastCLI Zen`
- `BeastCLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `beast` in prose when referring to the product name; use `BeastCLI`
