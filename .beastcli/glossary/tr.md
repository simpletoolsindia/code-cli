...
- PR #15835: https://github.com/simpletoolsindia/code-cli/pull/15835

## Do Not Translate (Locale Additions)

- `BeastCLI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `beast` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `BeastCLI` in prose, `beast` only for exact technical identifiers
...
- Avoid changing `beast` to `BeastCLI` inside commands, URLs, package names, or code literals
