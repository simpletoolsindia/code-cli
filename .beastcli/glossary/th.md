...
- PR #10809: https://github.com/simpletoolsindia/code-cli/pull/10809
- PR #11496: https://github.com/simpletoolsindia/code-cli/pull/11496

## Do Not Translate (Locale Additions)

- `BeastCLI` (preserve casing in prose; keep `beast` only in commands, package names, paths, or code)
- `BeastCLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
