...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/simpletoolsindia/code-cli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for simpletoolsindia/code-cli...\n")
...
console.log("Fetching npm all-time downloads for beastcli-ai...\n")
const npmDownloads = await fetchNpmDownloads("beastcli-ai")
