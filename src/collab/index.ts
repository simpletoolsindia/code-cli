...
export class CollabModeManager {
  ...
  getMode(): ModeConfig {
    ...
    return custom ?? COLLAB_MODES[this.currentMode]
  }
...
export const COLLAB_PRESETS = {
  // Quick review without editing
  readonly: {
    mode: 'review' as CollabMode,
    availableTools: ['Read', 'Grep', 'Glob'],
    maxTokens: 15000,
  },
...
export function applyPreset(
  ...
  presetName: keyof typeof COLLAB_PRESETS
): void {
