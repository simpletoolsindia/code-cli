...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 2.1 | Define interaction model — single keybindings vs mode switching | P0 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 3.1 | Audit and lock down color palette (foreground, accent, muted, semantic) | P0 | Pending |
| 3.2 | Audit and lock down typography (status bar, content area, input) | P0 | Pending |
| 3.3 | Audit and lock down spacing system (margins, padding, gaps) | P0 | Pending |
| 3.4 | Audit and lock down component API (Panel, Table, Badge, Progress) | P0 | Pending |
| 3.5 | Audit and lock down animation rules (timing, easing, what animates) | P1 | Pending |
| 3.6 | Define semantic tokens — error/fg vs fg.error vs theme.error | P0 | Pending |
| 3.7 | Write `DESIGN_SYSTEM.md` | P0 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 4.1 | **Status Bar** — model, session, progress, notifications | P0 | Pending |
| 4.2 | **Prompt Area** — multiline, character counter, mode indicator | P0 | Pending |
| 4.3 | **Assistant Message Area** — streaming, collapsed, scrollable | P0 | Pending |
| 4.4 | **Tool Call Log** — real-time tool execution, timing, result preview | P0 | Pending |
| 4.5 | **Diff View** — unified/split, line-by-line, inline comments | P0 | Pending |
| 4.6 | **Approval Prompts** — full-context dialogs, skip/abort/approve | P0 | Pending |
...
| 4.9 | **Settings/Help Panel** — keyboard shortcuts, config, model picker | P2 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 5.1 | Unified diff display (Git-style `+/−` lines) | P0 | Pending |
| 5.2 | Split-pane diff view with gutter indicators | P1 | Pending |
| 5.3 | Inline diff highlights (added=green, removed=red, changed=yellow) | P0 | Pending |
| 5.4 | File-level changeset summary (N files changed, N insertions, N deletions) | P0 | Pending |
| 5.5 | Collapsible diff sections for large files | P1 | Pending |
| 5.6 | Jump-to-change navigation (next/prev changed section) | P1 | Pending |
| 5.7 | Per-file approve/reject (approve some, reject others) | P1 | Pending |
| 5.8 | Write `DIFF_UX.md` design spec | P0 | Pending |
...
| 8.2 | Implement mode indicator in status bar | P0 | Pending |
| 8.3 | Implement keybindings: scroll, copy, expand, approve, reject | P0 | Pending |
| 8.4 | Implement vim-style navigation (j/k scroll, g/G top/bottom) | P1 | Pending |
| 8.5 | Implement command palette (`:` prefix) | P1 | Pending |
| 8.6 | Write `KEYBOARD_UX.md` design spec | P0 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 9.1 | Polish copy-to-clipboard with visual feedback | P1 | Pending |
| 9.2 | Polish approval flow with contextual confirm dialogs | P0 | Pending |
| 9.3 | Polish error messages with actionable suggestions | P0 | Pending |
| 9.4 | Polish streaming animation (tokens, tool call markers) | P0 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 10.1 | Enumerate existing user-visible behaviors (edge cases, error states) | P0 | Pending |
| 10.2 | Write integration tests covering critical paths | P0 | Pending |
| 10.3 | Tag current behavior with behavioral test suite | P0 | Pending |
...
| 10.6 | Write `REFACTOR_STRATEGY.md` | P0 | Pending |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 11.1 | macOS: Test all screens, keyboard shortcuts, colors | P0 | Pending |
| 11.2 | macOS: Test emoji rendering, box-drawing fallbacks | P0 | Pending |
...
| 11.5 | Test piped output (no TTY) on both platforms | P1 | Pending |
| 11.6 | Test 256-color and true-color terminal support | P1 | Pending |
| 11.7 | Write `CROSS_PLATFORM_QA.md` checklist | P0 | Pending |
