export const dict = {
  ...
  "desktop.menu.help.documentation": "BeastCLI Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "BeastCLI CLI binary is missing. Try reinstalling the desktop app.",
