export const dict = {
  ...
  "desktop.menu.help.documentation": "BeastCLI Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "BeastCLI CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
