    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://beastcli.ai/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/beastcli"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/simpletoolsindia/code-cli/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/simpletoolsindia/code-cli/issues/new?template=bug_report.yml"),
