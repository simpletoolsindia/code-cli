...
const releaseId = process.env.BEAST_RELEASE
if (!releaseId) throw new Error("BEAST_RELEASE is required")

const version = process.env.BEAST_VERSION
if (!version) throw new Error("BEAST_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "beastcli-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "beastcli-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "beastcli-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "beastcli-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "beastcli-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "beastcli-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "beastcli-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "beastcli-desktop-darwin-aarch64.app.tar.gz",
  },
]
