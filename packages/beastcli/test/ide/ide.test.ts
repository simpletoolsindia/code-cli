...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BEAST_CALLER", () => {
    process.env["BEAST_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BEAST_CALLER", () => {
    process.env["BEAST_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BEAST_CALLER", () => {
    process.env["BEAST_CALLER"] = "unknown"
