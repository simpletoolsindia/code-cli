...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips beastcli-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-beastcli-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-beastcli-directory")).toBeNull()
      expect(result.get("x-beastcli-workspace")).toBeNull()
