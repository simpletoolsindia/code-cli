...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips beastcli-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-beastcli-directory"]).toBeUndefined()
      expect(forwarded["x-beastcli-workspace"]).toBeUndefined()
