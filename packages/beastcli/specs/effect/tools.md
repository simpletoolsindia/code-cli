...
Practical reference for the current tool-migration state in `packages/beastcli`.
...
Tool tests should use the existing Effect helpers in `packages/beastcli/test/lib/effect.ts`:
