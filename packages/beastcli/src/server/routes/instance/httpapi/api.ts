...
export const RootHttpApi = HttpApi.make("beastcli-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("beastcli-instance")
...
export const BeastcliHttpApi = HttpApi.make("beast")
