...
>()("@simpletoolsindia/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@simpletoolsindia/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.BEAST_WORKSPACE_ID ? WorkspaceID.make(Flag.BEAST_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-beastcli-directory"] || currentDirectory()
}
