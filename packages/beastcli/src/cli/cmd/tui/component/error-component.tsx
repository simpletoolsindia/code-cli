...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/simpletoolsindia/code-cli/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("beastcli-version", InstallationVersion)
