...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@beastcli/sdk/v2"
      ...
      description={
        {
          beastcli: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://beastcli.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "beastcli-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://beastcli.ai/zen</span> and enable BeastCLI Go
              </text>
            </box>
          ),
