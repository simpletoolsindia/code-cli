...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.BEAST_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BEAST_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BEAST_WORKSPACE_ID: config.id,
        BEAST_EXPERIMENTAL_WORKSPACES: "true",
