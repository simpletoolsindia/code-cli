...
const BEAST_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.BEAST_DISABLE_EXTERNAL_SKILLS) {
    if (!Flag.BEAST_DISABLE_CLAUDE_CODE_SKILLS) externalDirs.push(CLAUDE_EXTERNAL_DIR)
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, BEAST_SKILL_PATTERN)
  }
