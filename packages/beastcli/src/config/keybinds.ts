...
const KeybindsSchema = Schema.Struct({
  ...
  help_show: keybind("ctrl+h,f1,ctrl+_,super+h", "Show help"),
  sidebar_toggle: keybind("<leader>b", "Toggle sidebar"),
  scrollbar_toggle: keybind("none", "Toggle session scrollbar"),
  username_toggle: keybind("none", "Toggle username visibility"),
  status_view: keybind("ctrl+l", "View status"),
  session_export: keybind("<leader>x", "Export session to editor"),
  session_new: keybind("<leader>n", "Create a new session"),
  session_list: keybind("ctrl+s", "List all sessions"),
  ...
  model_list: keybind("ctrl+o,ctrl+m", "List available models"),
  ...
  variant_cycle: keybind("none", "Cycle model variants"),
  ...
  input_delete_to_line_end: keybind("none", "Delete to end of line in input"),
