...
const TOOL_KEYWORDS: Record<string, string[]> = {
  ...
  current: ["websearch", "searxng_search"],
  latest: ["websearch", "searxng_search"],
  recent: ["websearch", "searxng_search"],
  today: ["websearch", "searxng_search"],
  news: ["websearch", "searxng_search"],
  election: ["websearch", "searxng_search"],
  elections: ["websearch", "searxng_search"],
