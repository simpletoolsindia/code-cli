...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@beastcli/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@beastcli/ToolRegistry") {}
