export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de BeastCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de BeastCLI. ¿Quieres instalarla y reiniciar?",
