export const dict = {
  ...
  "dialog.provider.beastcli.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.beastcli.tagline": "Modelos optimizados y fiables",
  "dialog.provider.beastcliGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en BeastCLI.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.beastcliZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.beastcliZen.visit.prefix": "Visita ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en BeastCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en BeastCLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados en beastcli.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de BeastCLI se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de BeastCLI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de BeastCLI",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (beastcli.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, BeastCLI no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor BeastCLI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para BeastCLI",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve BeastCLI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si BeastCLI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de BeastCLI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia BeastCLI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de BeastCLI.",
