export const dict = {
  ...
  "dialog.provider.beastcli.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.beastcli.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.beastcliGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BeastCLI-u.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.beastcliZen.visit.prefix": "Posjeti ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BeastCLI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BeastCLI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u beastcli.json",
  ...
  "dialog.server.description": "Promijeni na koji se BeastCLI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BeastCLI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BeastCLI timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (beastcli.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: BeastCLI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BeastCLI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BeastCLI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BeastCLI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li BeastCLI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BeastCLI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BeastCLI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BeastCLI-a.",
