export const dict = {
  ...
  "dialog.provider.beastcli.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.beastcli.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.beastcliGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i BeastCLI.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.beastcliZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.beastcliZen.visit.prefix": "Besøg ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i BeastCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i BeastCLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i beastcli.json",
  ...
  "dialog.server.description": "Skift hvilken BeastCLI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af BeastCLI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BeastCLI-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (beastcli.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, BeastCLI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BeastCLI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BeastCLI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan BeastCLI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om BeastCLI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan BeastCLI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BeastCLI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BeastCLI.",
