export const dict = {
  ...
  "dialog.provider.beastcli.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.beastcli.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.beastcliGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BeastCLI.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.beastcliZen.visit.prefix": "Odwiedź ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BeastCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BeastCLI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w beastcli.json",
  ...
  "dialog.server.description": "Przełącz serwer BeastCLI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BeastCLI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BeastCLI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (beastcli.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BeastCLI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BeastCLI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BeastCLI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy BeastCLI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BeastCLI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BeastCLI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BeastCLI.",
