...
export const dict = {
  ...
  "dialog.provider.beastcli.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.beastcli.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.beastcliGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i BeastCLI.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.beastcliZen.visit.prefix": "Besøk ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BeastCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BeastCLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i beastcli.json",
  ...
  "dialog.server.description": "Bytt hvilken BeastCLI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BeastCLI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BeastCLI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (beastcli.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BeastCLI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BeastCLI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BeastCLI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BeastCLI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om BeastCLI skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BeastCLI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BeastCLI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BeastCLI.",
