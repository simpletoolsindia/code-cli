export const dict = {
  ...
  "dialog.provider.beastcli.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.beastcli.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.beastcliGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no BeastCLI.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.beastcliZen.visit.prefix": "Visite ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no BeastCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no BeastCLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em beastcli.json",
  ...
  "dialog.server.description": "Trocar para qual servidor BeastCLI este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do BeastCLI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do BeastCLI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (beastcli.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: BeastCLI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor BeastCLI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do BeastCLI",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o BeastCLI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o BeastCLI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o BeastCLI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o BeastCLI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do BeastCLI.",
