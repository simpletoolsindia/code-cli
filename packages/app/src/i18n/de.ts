...
export const dict = {
  ...
  "dialog.provider.beastcli.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.beastcli.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.beastcliGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von BeastCLI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in BeastCLI zu nutzen.",
  ...
  "provider.connect.beastcliZen.line1":
    "BeastCLI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.beastcliZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.beastcliZen.visit.link": "beastcli.ai/zen",
  "provider.connect.beastcliZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in BeastCLI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in BeastCLI zu nutzen.",
  ...
  "dialog.plugins.empty": "In beastcli.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den BeastCLI-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von BeastCLI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem BeastCLI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (beastcli.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: BeastCLI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "BeastCLI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "BeastCLI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für BeastCLI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie BeastCLI auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob BeastCLI dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von BeastCLI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von BeastCLI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von BeastCLI.",
