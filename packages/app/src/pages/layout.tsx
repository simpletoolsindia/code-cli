...
import { ResizeHandle } from "@simpletoolsindia/ui/resize-handle"
...
import { Session, type Message } from "@simpletoolsindia/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@simpletoolsindia/ui/toast"
...
import { useTheme, type ColorScheme } from "@simpletoolsindia/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://beastcli.ai/desktop-feedback")}
      renderPanel={() =>
