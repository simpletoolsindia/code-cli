import { AppIcon } from "@simpletoolsindia/ui/app-icon"
...
import { Keybind } from "@simpletoolsindia/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_BEASTCLI_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("beastcli-titlebar-center"))
    setRightMount(document.getElementById("beastcli-titlebar-right"))
  })
