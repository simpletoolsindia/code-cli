import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@simpletoolsindia/sdk/v2/client"
import { Button } from "@simpletoolsindia/ui/button"
import { useDialog } from "@simpletoolsindia/ui/context/dialog"
import { Dialog } from "@simpletoolsindia/ui/dialog"
import { Icon } from "@simpletoolsindia/ui/icon"
import { IconButton } from "@simpletoolsindia/ui/icon-button"
import { List, type ListRef } from "@simpletoolsindia/ui/list"
import { ProviderIcon } from "@simpletoolsindia/ui/provider-icon"
import { Spinner } from "@simpletoolsindia/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "beast"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.beastcliZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.beastcliZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.beastcliZen.visit.prefix")}
                <Link href="https://beastcli.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.beastcliZen.visit.link")}
                </Link>
                {language.t("provider.connect.beastcliZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
