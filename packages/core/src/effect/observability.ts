...
import { ensureProcessMetadata } from "../util/beastcli-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "beastcli.client": Flag.BEAST_CLIENT,
      "beastcli.process_role": processMetadata.processRole,
      "beastcli.run_id": processMetadata.runID,
