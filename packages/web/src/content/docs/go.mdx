...
BeastCLI Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

:::note
BeastCLI Go is currently in beta.
:::

Go works like any other provider in BeastCLI. You subscribe to BeastCLI Go and
...
BeastCLI Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

BeastCLI Go works like any other provider in BeastCLI.

1. You sign in to **<a href={console}>BeastCLI Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `BeastCLI Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to BeastCLI Go.
:::
...
BeastCLI Go includes the following limits:
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.1           | glm-5.1           | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5             | glm-5             | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5         | kimi-k2.5         | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Pro       | mimo-v2-pro       | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni      | mimo-v2-omni      | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M2.7      | minimax-m2.7      | `https://beastcli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://beastcli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus      | qwen3.5-plus      | `https://beastcli.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |

The [model id](/docs/config/#models) in your BeastCLI config
uses the format `beastcli-go/<model-id>`. For example, for Kimi K2.6, you would
use `beastcli-go/kimi-k2.6` in your config.
...
```
https://beastcli.ai/zen/go/v1/models
```
...
4. Have **no lock-in** by allowing you to use any other provider with BeastCLI as well.
