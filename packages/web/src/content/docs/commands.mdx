...
Create `.beastcli/commands/test.md`:

```md title=".beastcli/commands/test.md"
---
...
You can add custom commands through the BeastCLI config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your BeastCLI [config](/docs/config):

```json title="beastcli.jsonc" {4-12}
{
...
- Global: `~/.config/beastcli/commands/`
- Per-project: `.beastcli/commands/`

```markdown title="~/.config/beastcli/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".beastcli/commands/component.md"
---
...
```md title=".beastcli/commands/create-file.md"
---
...
```md title=".beastcli/commands/analyze-coverage.md"
---
...
```md title=".beastcli/commands/review-changes.md"
---
...
```md title=".beastcli/commands/review-component.md"
---
...
beastcli includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
