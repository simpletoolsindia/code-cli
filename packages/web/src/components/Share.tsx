...
import { IconBeastcli } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "beastcli/session/message-v2"
import type { Message } from "beastcli/session/message"
import type { Session } from "beastcli/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.beastcli_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.beastcli_name}>
                    <IconBeastcli width={16} height={16} />
                  </div>
