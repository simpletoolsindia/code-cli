...
import desktopAppIcon from "../../asset/lander/beastcli-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://beastcli.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>beastcli.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g beastcli")}>
                <code>
                  npm i -g <strong>beastcli-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g beastcli-ai")}>
                <code>
                  bun add -g <strong>beastcli-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install simpletoolsindia/tap/code-cli")}>
                <code>
                  brew install <strong>simpletoolsindia/tap/code-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S beastcli")}>
                <code>
                  paru -S <strong>beastcli</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask beastcli-desktop")}>
                <code>
                  brew install --cask <strong>beastcli-desktop</strong>
                </code>
                <CopyStatus />
              </button>
