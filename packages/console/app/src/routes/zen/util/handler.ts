...
import { and, Database, eq, isNull, lt, or, sql } from "@beastcli/console-core/drizzle/index.js"
import { KeyTable } from "@beastcli/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@beastcli/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@beastcli/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@beastcli/console-core/util/date.js"
import { Identifier } from "@beastcli/console-core/identifier.js"
import { Billing } from "@beastcli/console-core/billing.js"
import { Actor } from "@beastcli/console-core/actor.js"
import { WorkspaceTable } from "@beastcli/console-core/schema/workspace.sql.js"
import { ZenData } from "@beastcli/console-core/model.js"
import { Subscription } from "@beastcli/console-core/subscription.js"
import { BlackData } from "@beastcli/console-core/black.js"
import { UserTable } from "@beastcli/console-core/schema/user.sql.js"
import { ModelTable } from "@beastcli/console-core/schema/model.sql.js"
import { ProviderTable } from "@beastcli/console-core/schema/provider.sql.js"
...
import { LiteData } from "@beastcli/console-core/lite.js"
import { Resource } from "@beastcli/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-beastcli-session") ?? ""
    const requestId = input.request.headers.get("x-beastcli-request") ?? ""
    const projectId = input.request.headers.get("x-beastcli-project") ?? ""
    const ocClient = input.request.headers.get("x-beastcli-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-beastcli-request")
          headers.delete("x-beastcli-session")
          headers.delete("x-beastcli-project")
          headers.delete("x-beastcli-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://beastcli.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://beastcli.ai/workspace/${authInfo.workspaceID}/members`
