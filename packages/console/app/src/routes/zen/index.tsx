...
import compareVideo from "../../asset/lander/beastcli-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/beastcli-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="beastcli:auth" content={loggedin() ? "true" : "false"} />
