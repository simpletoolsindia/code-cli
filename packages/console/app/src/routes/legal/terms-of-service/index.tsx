...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <title>BeastCLI | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="BeastCLI terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to BeastCLI. Please read on to learn the rules and restrictions that govern your use of
                BeastCLI&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("BeastCLI," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://beastcli.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-beastcli">What is BeastCLI?</h2>
              <p>
                BeastCLI is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the BeastCLI Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, BeastCLI enables you to
              ...
              <p>
                ...
                our site located at beastcli.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                BeastCLI takes the privacy of its users very seriously. For the current BeastCLI Privacy Policy, please
                click here{" "}
                <a href="https://beastcli.ai/legal/privacy-policy">https://beastcli.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using BeastCLI?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by BeastCLI;
                </li>
                <li>
              ...
              <p>
                If you use BeastCLI with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                BeastCLI. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                BeastCLI has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-beastcli-ever-change-the-services">Will BeastCLI ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://beastcli.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://beastcli.ai/auth">https://beastcli.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://beastcli.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                BeastCLI is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. BeastCLI has the sole right to decide whether you are
              ...
              <p>
                BeastCLI and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (BeastCLI and all such
                parties together, the "BeastCLI Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the BeastCLI Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The BeastCLI Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY BEASTCLI (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                BEASTCLI PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO BEASTCLI IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the BeastCLI Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without BeastCLI's prior written
              ...
              <p>
                ...
                disputes and claims with BeastCLI and limits the manner in which you can seek relief from BeastCLI. Both
                you and BeastCLI acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, BeastCLI's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. BeastCLI will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. BeastCLI will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or BeastCLI may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND BEASTCLI WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and BeastCLI are instead choosing to have claims and disputes resolved by
                ...
                you and BeastCLI over whether to vacate or enforce an arbitration award, YOU AND BEASTCLI WAIVE ALL
              ...
              <p>
                ...
                BeastCLI is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or BeastCLI to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and BeastCLI agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the BeastCLI may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and BeastCLI agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and BeastCLI, and
                ...
                are not an employee, agent, partner, or joint venture of BeastCLI, and you do not have any authority of
                any kind to bind BeastCLI in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and BeastCLI
